...
public class Main {
	...
	public static void main(String[] args) {
		...
		//State State
		Module sprayer_in_hand = new Module((float) 5,"sprayer_in_hand");
		Module sander_in_hand = new Module((float) 5,"sander_in_hand");
		Module board_in_hand = new Module((float) 5,"board_in_hand");
		Module board_in_vise = new Module((float) 5,"board_in_vise");
		
		Module pick_up_sprayer = new Module((float) 5,"pick_up_sprayer");
		...
		Module pick_up_sander = new Module((float) 5,"pick_up_sander");
		...
		Module pick_up_board = new Module((float) 5,"pick_up_board");
		...
		Module put_down_sprayer = new Module((float) 5,"put_down_sprayer");
		...
		Module put_down_sander = new Module((float) 5,"put_down_sander");
		...
		Module put_down_board = new Module((float) 5,"put_down_board");
		...
		Module sand_board_in_vise = new Module((float) 5,"sand_board_in_vise");
		...
		Module spray_paint_self = new Module((float) 5,"spray_paint_self");
		...
		Module place_board_in_vise = new Module((float) 5,"place_board_in_vise");
