...
public class Main {
	...
	public static void main(String[] args) {
		...
		pick_up_sander.addCondition("sander_somewhere", true);
		pick_up_sander.addCondition("hand_is_empty", true);
		pick_up_sander.addAjoutes("sander_in_hand", false);
		pick_up_sander.addDetruits("sander_somewhere", true);
		pick_up_sander.addDetruits("hand_is_empty", true);
		
		Module pick_up_board = new Module((float) 0,"pick_up_board");
		pick_up_board.addCondition("board_somewhere", true);
		pick_up_board.addCondition("hand_is_empty", true);
		pick_up_board.addAjoutes("board_in_hand", false);
		pick_up_board.addDetruits("board_somewhere", true);
		pick_up_board.addDetruits("hand_is_empty", true);
		
		Module put_down_sprayer = new Module((float) 0,"put_down_sprayer");
		put_down_sprayer.addCondition("sprayer_in_hand", false);
		put_down_sprayer.addAjoutes("sprayer_somewhere", true);
		put_down_sprayer.addAjoutes("hand_is_empty",true);
		put_down_sprayer.addDetruits("sprayer_in_hand", false);
		
		Module put_down_sander = new Module((float) 0,"put_down_sander");
		put_down_sander.addCondition("sander_in_hand", false);
		put_down_sander.addAjoutes("sander_somewhere", true);
		put_down_sander.addAjoutes("hand_is_empty", true);
		put_down_sander.addDetruits("sander_in_hand", false);
		
		Module put_down_board = new Module((float) 0,"put_down_board");
		put_down_board.addCondition("board_in_hand", false);
		put_down_board.addAjoutes("board_somewhere", true);
		put_down_board.addAjoutes("hand_is_empty", true);
		put_down_board.addDetruits("board_in_hand", false);
		...
		sand_board_in_vise.addCondition("operationnal", true);
		sand_board_in_vise.addCondition("board_in_vise", false);
		sand_board_in_vise.addCondition("sander_in_hand", false);
		sand_board_in_vise.addAjoutes("board_sanded", false);
		
		Module spray_paint_self = new Module((float) 0,"spray_paint_self");
		spray_paint_self.addCondition("operationnal", true);
		spray_paint_self.addCondition("sprayer_in_hand", false);
		spray_paint_self.addAjoutes("self_painted", false);
		spray_paint_self.addDetruits("operationnal", true);
		
		Module place_board_in_vise = new Module((float) 0,"place_board_in_vise");
		place_board_in_vise.addCondition("board_in_hand", false);
